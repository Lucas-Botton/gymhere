...
export const COACHES: Coach[] = [
  {
    ...
    availability: {
      Présentiel: { Lun: [{ from: '07:00', to: '12:00' }, { from: '17:00', to: '20:00' }], Mar: [{ from: '17:00', to: '20:00' }], Jeu: [{ from: '07:00', to: '12:00' }], Ven: [{ from: '12:00', to: '14:00' }, { from: '17:00', to: '20:00' }], Sam: [{ from: '09:00', to: '13:00' }] },
  ...
  },
  {
    ...
    availability: {
      Présentiel: { Lun: [{ from: '18:00', to: '21:00' }], Mer: [{ from: '18:00', to: '21:00' }], Ven: [{ from: '17:00', to: '20:00' }], Sam: [{ from: '10:00', to: '13:00' }] },
  ...
  },
  {
    ...
    availability: {
      Présentiel: { Mar: [{ from: '18:00', to: '20:30' }], Jeu: [{ from: '18:00', to: '20:30' }], Sam: [{ from: '09:00', to: '12:00' }] },
